...
import com.example.myzodiacapp.databinding.FragmentLoveStyleBinding


class LoveStyleFragment : Fragment() {

    private var _binding: FragmentLoveStyleBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentLoveStyleBinding.inflate(inflater, container, false)
        val view = binding.root

        when(LoveStyleFragmentArgs.fromBundle(requireArguments()).zodiacSign) {
        ...
        binding.btnHome.setOnClickListener {
            view.findNavController()
                .navigate(R.id.action_loveStyleFragment_to_mainFragment)
        }
